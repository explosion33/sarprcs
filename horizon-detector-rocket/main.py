...
def main():
    ...
    cv2.putText(paused_frame, 'Real-time display is paused.', (20, 30), cv2.FONT_HERSHEY_COMPLEX_SMALL, .75,
                (255, 255, 255), 1, cv2.LINE_AA)
    cv2.putText(paused_frame, "Press 'd' to enable real-time display.", (20, 60), cv2.FONT_HERSHEY_COMPLEX_SMALL, .75,
                (255, 255, 255), 1, cv2.LINE_AA)
    cv2.putText(paused_frame, "Press 'r' to record.", (20, 90), cv2.FONT_HERSHEY_COMPLEX_SMALL, .75, (255, 255, 255), 1,
                cv2.LINE_AA)
    cv2.putText(paused_frame, "Press 'q' to quit.", (20, 120), cv2.FONT_HERSHEY_COMPLEX_SMALL, .75, (255, 255, 255), 1,
                cv2.LINE_AA)
    ...
    while video_capture.run:
        ...
        if key == ord('q'):
            ...
            file_path = r'C:\Users\fergu\PycharmProjects\horizon_detector\recording.mp4'
